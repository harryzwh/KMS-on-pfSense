...
echo "#!/bin/sh" > /usr/local/etc/rc.syshook.d/start/50-kms
echo "/usr/local/etc/rc.d/kms_start.sh" >> /usr/local/etc/rc.syshook.d/start/50-kms
}
...
chmod 755 /usr/local/etc/rc.syshook.d/start/50-kms
